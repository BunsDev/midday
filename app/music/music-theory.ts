import { type Chord, CHROMATIC_SCALE, COMMON_DURATIONS, MAJOR_SCALE_INTERVALS, MINOR_SCALE_INTERVALS } from "../lib/constants";
...
export class MusicTheory {
  ...
  public getScaleNotes(root: string, scaleType: "major" | "minor"): string[] {
    ...
    return scaleIntervals.map((interval) => CHROMATIC_SCALE[(rootIndex + interval) % 12]);
  }
